...
const Doctors = () => {
  ...
  const filtered = searchTerm ? doctors.filter(d => (d.address.line1.toLowerCase().includes(searchTerm) || d.address.line2.toLowerCase().includes(searchTerm))) : doctors

  return (
    <div>
      <p className='text-gray-600'>Browse through the doctors specialist.</p>
      <div className="py-4 border-b">
        <Input name="location search" placeholder="Search by location..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
      </div>
